...
document.addEventListener('load', dibujarMatrix('A', contadorClicks.A));
document.getElementById('incrementarDimension').addEventListener('click', () => incrementarDimension('A'));
document.getElementById('reducirDimension').addEventListener('click', () => reducirDimension('A'));
